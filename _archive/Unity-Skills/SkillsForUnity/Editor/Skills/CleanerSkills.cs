    ...
    public static class CleanerSkills
    {
            ...
            string confirmToken = null)
        {
            ...
            return new
            {
                ...
                confirmToken = token,
                message = $" PREVIEW ONLY - {previewResults.Count(r => ((dynamic)r).exists)} assets will be deleted ({totalBytes / (1024.0 * 1024.0):F2} MB). To confirm, call again with confirmToken='{token}'",
                expiresIn = "5 minutes",
