...
-  **543 REST Skills Comprehensive Toolkit**: Includes 13 advisory design modules with Batch operations for multi-object control.
-  **Dual-Mode Flexibility**: Switch between Semi-Auto (code-first) and Full-Auto (direct manipulation) for different workflows.
-  **4 Major IDEs Native Support**: Claude Code / Antigravity / Gemini CLI / Codex — one-click install and use.
-  **Transactional Atomicity**: Failed operations auto-rollback, leaving scenes clean and safe.
...
-  **Anti-Hallucination Guardrails**: Each Skill module includes DO NOT lists and routing rules to prevent calls to nonexistent commands or parameter errors.
...
##  Quick Install Supported IDE/Terminals
...
>  Most modules support `*_batch` batch operations. When operating on multiple objects, prioritize batch Skills for better performance.
>
