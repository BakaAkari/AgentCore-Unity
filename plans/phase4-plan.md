...
| 优先级 | 任务编号 | 任务名称 | 复杂度 | 依赖 |
|--------|---------|---------|--------|------|
| P0 | 4.1 | Markdown 渲染 | 高 | 无 |
| P0 | 4.3 | 键盘快捷键完善 | 低 | 无 |
| P1 | 4.2 | 错误处理与重试 UI | 中 | 无 |
| P1 | 4.4 | 工具启用/禁用管理 | 中 | 无 |
| P1 | 4.7 | 导出对话记录 | 低 | 无 |
| P2 | 4.6 | MEMORY.md / USER.md 编辑器集成 | 低 | 无 |
| P2 | 4.5 | Fallback 策略表 UI 编辑器 | 中 | 4.2 |
| P3 | 4.8 | 完善文档和示例 | 低 | 全部 |
